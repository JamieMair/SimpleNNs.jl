@testitem "Dense Network Forward Performance" begin
    using Random
    Random.seed!(42)
...
@testitem "Dense Network Backward Performance" begin
    using Random
    Random.seed!(42)
...
@testitem "Convolutional Network Forward Performance" begin
    using Random
    Random.seed!(42)
...
@testitem "Convolutional Network Backward Performance" begin
    using Random
    Random.seed!(42)
