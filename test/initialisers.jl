@testitem "GlorotNormal initialization" begin
    using Statistics
    using Random
    Random.seed!(42)
...
@testitem "HeNormal initialization" begin
    using Statistics
    using Random
    Random.seed!(42)
...
@testitem "GlorotUniform initialization" begin
    using Random
    Random.seed!(42)
...
@testitem "Zeros initialization" begin
    model = chain(
        Static(10),
...
@testitem "Convolutional layer initialization" begin
    using Statistics
    using Random
    Random.seed!(42)
...
@testitem "Bias initialization" begin
    using Random
    Random.seed!(42)
...
@testitem "Re-initialization" begin
    using Random
    Random.seed!(42)
